...
def test() :
	...
	testLoader = helper.PreprocessData(imTransform, sliceNames, rootDirTest, 'input', 'segments', batchSize, False)
		...
		for dispIndex in range(len(blurOut)) :
			...
			if dispIndex == 0 :
				...
				for indices in range(numSlices) :
					...
					groundTruthDir = dirToWrite + 'GroundTruth/'
					...
					groundTruthDispOut = helper.TensorToDispImage(nearFocusGTSlices[indices], 3)
					focalSliceDispOut = helper.TensorToDispImage(nearFocusOutSlices[indices], 3)
					#binaryMapDispOut = helper.TensorToDispImage(binaryBlurMapSlices[indices], 3, False)
					...
					save_image(groundTruthDispOut, groundTruthDir + str(step) + ".png", nrow=8, padding=2, normalize=False, range=None, scale_each=False, pad_value=0)
...
if goldenTest == False :
	rootDirTest		= '/home/sajal.maheshwari/BlurMapExp/FSDataLarge/testData/'
	rootDirLoad		= '/home/sajal.maheshwari/BlurMapExp/Baseline2SlicesInterleaved/checkpoints/'
	rootDirResults	= '/home/sajal.maheshwari/BlurMapExp/Baseline2SlicesInterleaved/results/'
	#rootDirTest		= '/home/sajal/Desktop/FSDataLarge/testData/'
	#rootDirLoad		= '/home/sajal/Desktop/BlurMapFinalExperiments/Baseline2SlicesNoBinary/checkpoints/'
	#rootDirResults	= '/home/sajal/Desktop/BlurMapFinalExperiments/Baseline2SlicesNoBinary/results/'
else :
